...
export default function StudentHomePage() {
  ...
  return (
    <div className="min-h-screen bg-role-student">
      {/* Header */}
          ...
          <div className="card-body">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                ...
                <p className="text-neutral-600">Student Number: <span className="font-mono">{student.studentNumber}</span></p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
              <div className="flex items-center gap-3 p-4 bg-primary-50 rounded-lg elevated">
                ...
                <div>
                  <p className="text-sm text-neutral-600">Enrolled Modules</p>
                  <p className="text-2xl font-display font-bold text-neutral-800">{modules?.length || 0}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-accent-50 rounded-lg elevated">
                <Calendar className="text-accent-600" size={24} />
                <div>
                  <p className="text-sm text-neutral-600">Upcoming Assessments</p>
                  <p className="text-2xl font-display font-bold text-neutral-800">{upcomingAssessments?.length || 0}</p>
                </div>
              </div>
              <div className="flex items-center gap-3 p-4 bg-success-50 rounded-lg elevated">
                <Award className="text-success-600" size={24} />
                <div>
                  <p className="text-sm text-neutral-600">Average Performance</p>
                        ...
                        <div className="p-5">
                          <div className="flex items-start justify-between mb-3">
                            <div className="flex-1">
                              <div className="flex items-center gap-2 mb-1">
                                <h4 className="font-display font-semibold text-neutral-800 text-lg group-hover:text-primary-600 transition-colors">
                                  {module.moduleCode}
                                </h4>
                          ...
                          {module.performance && (
                            <div className="grid grid-cols-3 gap-3 pt-3 border-t border-neutral-100">
                              ...
                              <div>
                                <p className="text-xs text-neutral-500 uppercase tracking-wide">Attendance</p>
                                <p className="font-semibold text-neutral-800">
                              ...
                              <div>
                                <p className="text-xs text-neutral-500 uppercase tracking-wide">Submissions</p>
                                <p className="font-semibold text-neutral-800">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-start justify-between mb-2">
                            <h4 className="font-semibold text-neutral-800 text-sm flex-1 pr-2">
                          ...
                          <p className="text-xs text-neutral-600 mb-3">{assessment.module.moduleCode}</p>
